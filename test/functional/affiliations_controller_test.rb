...
class AffiliationsControllerTest < ActionController::TestCase
  ...
  test "should create affiliation" do
    assert_difference('Affiliation.count') do
      post :create, affiliation: { first_pre_id: @affiliation.first_pre_id, relationship: @affiliation.relationship, second_pre_id: @affiliation.second_pre_id }
    end
  ...
  test "should update affiliation" do
    put :update, id: @affiliation, affiliation: { first_pre_id: @affiliation.first_pre_id, relationship: @affiliation.relationship, second_pre_id: @affiliation.second_pre_id }
    assert_redirected_to affiliation_path(assigns(:affiliation))
  end
